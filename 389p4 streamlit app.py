...
APP_VERSION = "v155_BUILD_LABEL_AND_EMPTY_STATE"
...
# --- BUILD STAMP (auto) ---
APP_BUILD_ID = "v156_PERSIST_UPLOADS_FIX_EMPTY_STATES"
...
tab_labels = [f"Northern Star (v51) — {APP_VERSION}", "Northern Lights (Master playlist)", "Core view", "Backtest (optional)", "7-Core Execution (Play Today)"]
