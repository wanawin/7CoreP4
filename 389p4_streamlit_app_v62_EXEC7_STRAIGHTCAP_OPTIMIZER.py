...
# Combined lookups: base + optional extra core tables
seed_traits_pos_lookup = {**seed_traits_pos_lookup, **core_extra_pos_lookup}
seed_traits_neg_lookup = {**seed_traits_neg_lookup, **core_extra_neg_lookup}
